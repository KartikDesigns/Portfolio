...
<body style="font-family:'Poppins',sans-serif; background:#0f172a; color:#f1f5f9; text-align:center; padding:2rem;">

  <h1 style="font-size:2.8rem; font-weight:600; margin-bottom:0.5rem;">Hi 👋, I'm Kartik</h1>
  <h3 style="font-weight:400; font-size:1.3rem; color:#38bdf8; margin-bottom:2.5rem;">Designing universes out of imagination</h3>
